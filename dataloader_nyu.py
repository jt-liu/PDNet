...
def getTrainingTestingData(batch_size):
    ...
    return DataLoader(transformed_training, batch_size, shuffle=True, num_workers=8, pin_memory=True), DataLoader(transformed_testing, batch_size, shuffle=False, num_workers=4, pin_memory=True)
